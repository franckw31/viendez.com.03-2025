...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['submit-desins'])) {
        ...
        if ($rowcount == '1') { 
            ...
            $sql2 = mysqli_query($con, "UPDATE `participation` SET `id-membre`='$lois',`position`='0',`id-activite`='$activi',`option`='Annule',`ds`= CURRENT_TIMESTAMP WHERE `participation`.`id-participation` = '$id_part'");
                                                                            ...
                                                                            <div id="bSection">
                                                                                ...
                                                                                <div id="t1E">
                                                                                    <div class="ccontainer-fluid ccontainer-fullw bbg-white ">                                                                                                                                                                        
                                                                                        <?php
                                                                                        // $tableau=array();
                                                                                        $sql = mysqli_query($con, "SELECT  `id-membre`,`position`,`id-participation` FROM `participation` WHERE `id-activite` = '30'  ORDER BY `position` LIMIT 8");
...
<div id="main">
    <div class="players">
        <div class="player player-1 playing" id="player1" >
            <div class="avatar p1" style="bbackground: blue;">
            <form method="post">
                    ...
                    <button 
                        ...
                        class="btnn btn-primary-blue btn-block font-size:30px  "
        ...
        <div class="player player-2 playing"  id="player2">
            <div class="avatar p2" style="bbackground: red;">
                <form method="post">
                    <button 
                        type="submit"
                        id='submitpl'
                        value=<?php echo $tableau1[1] ?>
                        class="btnn btn-primary-blue btn-block font-size:12px"
        ...
        <div class="player player-3 playing"  id="player3">
            <div class="avatar p3" style="bbackground: black">
            <form method="post">
                <button 
                    type="submit"
                    id='submitpl'
                    value=<?php echo $tableau1[2] ?>
                    class="btnn btn-primary-blue btn-block font-size:1.5vw"
        ...
        <div class="player player-4 playing"  id="player4">
            <div class="avatar p4" style="bbackground: orange;">
            <form method="post">
                    <button 
                        type="submit"
                        id='submitpl'
                        value=<?php echo $tableau1[3] ?>
                        class="btnn btn-primary-blue btn-block font-size:3nv"
                        name="submitpl"><?php echo $tableau3[3] ?>
                    </button>
            </div>
        </div>
        <div class="player player-5 playing"  id="player5">
            <div class="avatar p5" style="bbackground: grey;">
            <form method="post">
                    <button 
                        type="submit"
                        id='submitpl'
                        value=<?php echo $tableau1[4] ?>
                        class="btnn btn-primary-blue btn-block font-size:13px"
                        name="submitpl"><?php echo $tableau3[4] ?>
                    </button>
            </div>
        </div>
        <div class="player player-6 playing"  id="player6">
            <div class="avatar p6" style="bbackground: brown;">
        ...
        <div class="player player-7 playing"  id="player7">
            <div class="avatar p7" style="bbackground: pink;">
        ...
        <div class="player player-8 playing"  id="player8">
            <div class="avatar p8" style="bbackground: purple;">
        ...
        <div class='square-content'> <span>TABLE N°1</span></div>
                                                                                ...
                                                                                <div id="t2E">
                                                                                    <div class="ccontainer-fluid ccontainer-fullw bbg-white ">                                                                                                                                                                        
                                                                                        ...
                                                                                        $sql = mysqli_query($con, "SELECT  `id-membre`,`position`,`id-participation` FROM `participation` WHERE (`id-activite` = '30' AND `position` > 8)  ORDER BY `position` ");
                                                                                        $nb_lignes=mysqli_num_rows($sql);
                                                                                        // echo $nb_lignes;
        ...
        <div class="player player-1 playing" id="player1" >
            ...
            <form method="post">
                    ...
                    <button 
                        ...
                        id='submitpl'
                        value=<?php echo $tableau1[0] ?>
                        class="bbtn btn-primary btn-block font-size:13px "
                        name="submitpl"><?php echo $tableau3[0] ?>
                    </button>
                </form>
            </div>
            ...
            <div class="avatar p2" style="background: red;">
                <form method="post">
                    <button 
                        ...
                        id='submitpl'
                        value=<?php echo $tableau1[1] ?>
                        class="bbtn btn-primary btn-block font-size:12px"
                        name="submitpl"><?php echo $tableau3[1] ?>
                    </button>
                </form>
            </div>
