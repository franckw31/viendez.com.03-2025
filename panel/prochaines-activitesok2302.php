...
if (isset($_GET['id'])) {
	$adminid = $_GET['id'];
	$msg = mysqli_query($con, "delete from activite where id='$adminid'");
	if ($msg) {
                                                    ...
                                                    <main>
                                                        <div class="container-fluid px-4">
                                                            ...
                                                            <ol class="breadcrumb mb-4">
                                                                ...
                                                                <li class="breadcrumb-item active">Prochaines Activités
                                                                </li>
                                                            </ol>
                                                            <div class="card mb-4">
                                                                ...
                                                                <div class="card-body">
                                                                    <table id="datatablesSimple">
                                                                        ...
                                                                        <tbody>>
                                                                            <?php $ret = mysqli_query($con, "select * from activite where date_depart <> '0000-00-00' and datediff(date_depart,now())>-1 order by date_depart");
																				$cnt = 1;
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <a href="prochaines-activites.php?uid=<?php echo $row['id']; ?>"
