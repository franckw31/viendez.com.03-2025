                                                                    ...
                                                                    <div id="contenu">
                                                                        <div id="auCentre">
                                                                            ...
                                                                            {?>
                                                                                ...
                                                                                <a href="voir-blindes.php?uid=<?php echo $id; ?>" id="blindes" class="btnnav" onmouseover="window.location=this.href">Timer</a>
                                                                            ...
                                                                            <div id="bSection">
                                                                                                                    ...
                                                                                                                    while ($row2 = mysqli_fetch_array($sql2)) { $nom_org = $row2['pseudo']; } ?>
                                                                                                                        ...
                                                                                                                        <table class="table table-bordered">            
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                                                ...
                                                                                                                                                                <th><a href="creation-blindes.php?act=<?php echo $row['id-activite']; ?>&sou=/panel/voir-activite.php">Heure</a></th>
                                                                                ...
                                                                                <!-- <script >responsiveVoice.speak("Table 1","French Female",{volume: 1})</script> -->
                                                                                    ...
                                                                                    <div class='info2-content '> <?php echo "Bulle : " ?>
                                                                                        <?php
                                                                                        if ($rowcount2>0) { $bul=2; };
                                                                                        if ($rowcount2>5) { $bul=3; };
                                                                                        if ($rowcount2>8) { $bul=4; };
                                                                                        if ($rowcount2>13) { $bul=5; };
                                                                                        if ($rowcount2>20) { $bul=6; };
                                                                                        $sql = mysqli_query($con, "SELECT * FROM `participation` WHERE (`id-activite` = $id AND `option` NOT LIKE 'Elimine' )");
                                                                                        $rowcount = mysqli_num_rows($sql);
                                                                                        $sql = mysqli_query($con, "SELECT * FROM `participation` WHERE (`id-activite` = $id AND `option` NOT LIKE 'Annule' )");
                                                                                        $rowcount2 = mysqli_num_rows($sql);
                                                                                    ...
                                                                                    <div class='info2-content'> 
                                                                                        ...
                                                                                        if ($rowcount2>13) { $payes=4; $r1=0.51; $r2=0.25; $r3=0.17; $r4=0.07; };
                                                                                        ...
                                                                                        if ($payes==4) {
                                                                                            ...
                                                                                            $p2=$final * $r2; $p2=$p2/10; $p2=round($p2,0); $p2=$p2*10;
                                                                                            $p1=$final-$p4-$p3-$p2;
                                                                                            ?> <div class='info4-content '> <?php echo "Pot total : ".$final." soit : "."P1=".$p1.", P2=".$p2.", P3=".$p3.", P4=".$p4." Cacahuètes !" ?></div><?php
                                                                                        };
                                                                                        if ($payes==5) {
