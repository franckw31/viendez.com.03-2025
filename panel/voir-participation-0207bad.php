                                                                                        ...
                                                                                        <form method="post">
                                                                                            <table class="table table-bordered">
                                                                                                <tr>
                                                                                                                                            ...
                                                                                                                                            <th><a href="voir-membre.php?id=<?php echo $monmembre; ?>">Membre <?php echo ": ".$nommembre;?></a></th>
                                                                                                                                                ...
                                                                                                                                                <td>
                                                                                                                                                   <!-- <label for="option"></label> -->
                                                                                                                                                    <select name="option" id="option" class="form-control" type="text">
                                                                                                                                                        ...
                                                                                                                                                        <?php if ($row['option'] <> 'Partage') echo "<option value='Partage'>Partage</option>";?>
                                                                                                                                                        <?php if ($row['option'] <> 'ITM') echo "<option value='ITM'>ITM</option>";?>
                                                                                                                                                        <?php if ($row['option'] <> 'Bulle') echo "<option value='Bulle'>Bulle</option>";?> 
                                                                                                                                                    </select>
                                                                                                                                                </td>
                                                                                                                                                <th>Etat</th>
                                                                                                                                                <td><input
