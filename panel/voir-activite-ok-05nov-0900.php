                                                                    ...
                                                                    <div id="contenu">
                                                                        <div id="auCentre">
                                                                            <div id="bMenu">
                                                                                ...
                                                                                <a href="#" id="ks" class="btnnav" onmouseover="afficher('ks')">Inscrits</a>
                                                                                <a href="#" id="php" class="btnnav" onmouseover="afficher('php')">Tables</a>
                                                                                <a href="#" id="js" class="btnnav" onmouseover="afficher('js')">Timer</a>
                                                                            </div>
                                                                            <div id="bSection">
                                                                                <div id="cssE">
                                                                                    <div class="wrap-content container" id="container">
                                                                                ...
                                                                                <div id="phpE">
                                                                                    <div class="ccontainer-fluid ccontainer-fullw bbg-white ">                                                                                                                                                                        
                                                                                        <?php
                                                                                        // $tableau=array();
                                                                                        $sql = mysqli_query($con, "SELECT  `id-membre`,`position`,`id-participation` FROM `participation` WHERE `id-activite` = '30'  ORDER BY `position` ");
