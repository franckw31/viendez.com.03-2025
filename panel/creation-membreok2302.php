...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "INSERT INTO `membres` (`pseudo`, `droits`, `fname`, `lname`, `posting_date`, `association_date`, `lastip`, `nbpoints`, `password`, `naissance_date`, `CodeV`, `verification`, `telephone`, `email`, `photo`, `photo-map`, `commentaire`, `rue`, `ville`, `longitude`, `latitude`, `icon`, `ico-siz`, `lien`, `lien-id`, `lien-texte`, `lien-texte-fin`) VALUES ('$pseudo', '0', '$fname', '$lname', CURRENT_TIMESTAMP, '$association_date', NULL, '0', '$password', '$naissance_date', '', '0', '$telephone', '$email', 'perso.png', 'url(https://poker31.org/panel/images/', '$intval', '$rue', '$ville', '', '', 'poker', '', '<a href=\"/panel/voir-membre.php?uid=', '', '\">', 'Cliquer Pour Infos')");
        $_SESSION['msg'] = "MAJ Ok !!";
    }
