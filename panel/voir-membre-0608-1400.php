                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    while ($row = mysqli_fetch_array($sql)) {
                                                                        ...
                                                                        <table class="table table-bordered current-user">
                                                                            <tr>
                                                                                <td rowspan="3" text-align=center><img
                                                                                        src="images/<?php echo $row['photo']; ?>"
                                                                                        width="85" height="85"
                                                                                        style="text-align:center">
                                                                                    <form id="image_upload_form"
                                                                                        enctype="multipart/form-data"
                                                                                        action="uploadokvide.php?editid=<?php echo $id; ?>"
                                                                            ...
                                                                            <tr>
                                                                                <th>Prénom</th>
                                                                                <td><input class="form-control" id="fname"
                                                                                        name="fname" type="text"
                                                                                        value="<?php echo $row['fname']; ?>">
                                                                                </td>
                                                                                <th>Nom</th>
                                                                                <td><input class="form-control" id="lname"
                                                                            ...
                                                                            <th>CodeV</th>
                                                                            <td><input class="form-control" id="CodeV"
                                                                                    name="CodeV" type="text"
                                                                                                        ...
                                                                                                        while ($row = mysqli_fetch_array($ret)) { ?>
                                                                                                            ...
                                                                                                            while ($row2 = mysqli_fetch_array($sql2)) { ?>
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <a
                                                                                                                            href="voir-activite.php?uid=<?php echo $row['id-activite']; ?>"><?php echo $row2['titre-activite']; ?></a>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <?php echo $row2['ville']; ?>
                                                                                                                    </td>
