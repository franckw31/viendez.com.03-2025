...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['submit-desins'])) {
        ...
        if ($rowcount == '1') { 
            ...
            $sql2 = mysqli_query($con, "UPDATE `participation` SET `id-membre`='$lois',`id-activite`='$activi',`option`='Annule',`ds`= CURRENT_TIMESTAMP WHERE `participation`.`id-participation` = '$id_part'");
