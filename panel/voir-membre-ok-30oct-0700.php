                                                                ...
                                                                while ($row = mysqli_fetch_array($sql)) {
                                                                    ?>
                                                                        ...
                                                                        <table class="table table-bordered current-user">
                                                                            <tr> 
                                                                                <td colspan="2" align=center><img src="images/<?php echo $row['photo']; ?>" width="85" height="85" style="align:center">
                                                                                    <form id="image_upload_form" enctype="multipart/form-data" action="uploadokvide.php?editid=<?php echo $id; ?>" method="post" class="change-pic">
                                                                                        ...
                                                                                        <!-- <input style="padding-left:2px; color:#4d4d4d" type="file"  id="file" name="fileToUpload" accept="image/*" /> -->
                                                                                        <input type="file"  id="file" name="fileToUpload"  style="display:none;"/><input type="button" onClick="fileToUpload.click();" value="Modifier"/>
                                                                                        <script type="text/javascript">
