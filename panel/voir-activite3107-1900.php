...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['submit-desins'])) {
        ...
        if ($option = 'Annule') {
            ...
            echo "jkljmlkjmlkjmlkjmkljmlkjmlk";
                                ...
                                <div id="auCentre">
                                    ...
                                    if ($nbt == '1') { ?>
                                        <div id="bMenu">
                                            ...
                                            <a href="#" id="inscrits" class="btnnav"
                                                onmouseover="afficher1('inscrits')">Inscrits</a>
                                            ...
                                            <a href="voir-blindes.php?uid=<?php echo $id; ?>" id="blindes" class="btnnav"
                                                onmouseover="window.location=this.href">Timer</a>
                                    ...
                                    if ($nbt == '2') { ?>
                                        <div id="bMenu">
                                            ...
                                            <a href="#" id="inscrits" class="btnnav"
                                                onmouseover="afficher2('inscrits')">Inscrits</a>
                                    ...
                                    <div id="bSection">
                                                                        ...
                                                                        while ($row = mysqli_fetch_array($sql)) {
                                                                            ...
                                                                            <table class="table table-bordered">
                                                                                <tr>
                                                                                    <td rowspan="2"><img
                                                                                        ...
                                                                                        <form id="image_upload_form"
                                                                                            ...
                                                                                            action="upload-photo-activite.php?editid=<?php echo $id ?>"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th><a
                                                                                            href="creation-blindes.php?act=<?php echo $row['id-activite']; ?>&sou=/panel/voir-activite.php">Heure</a>
                                                                                    </th>
                                                                                ...
                                                                                <tr>
                                                                                    <th><a
                                                                                            href="voir-membre.php?id=<?php echo $row['id-membre']; ?>">Orga:
                                                                                            <?php echo " " . $nom_org . " "; ?></a>
                                                                                    </th>
                                                                                ...
                                                                                <tr>
                                                                                    <th>lng</th>
                                                                                    <td><input class="form-control" id="lng"
                                                                                            name="lng" type="text"
                                                                                            value="<?php echo $row['lng']; ?>">
                                                                                    </td>
                                                                                    <th>lat</th>
                                                                                    <td><input class="form-control" id="lat"
                                                                                            name="lat" type="text"
                                                                                    ...
                                                                                    <!-- <td>
                                                                                                                                                                <label for="commentaire"></label>
                                                                                                                                                                    <select name="commentaire" id="commentaire">
                                                                                                                                                                        ...
                                                                                                                                                                        <?php if ($row['commentaire'] <> '1')
                                                                                                                                                                            echo "<option value='1'>1</option>"; ?> 
                                                                                                                                                                        <?php if ($row['commentaire'] <> '2')
                                                                                                                                                                            echo "<option value='2'>2</option>"; ?> 
                                                                                                                                                                        <?php if ($row['commentaire'] <> '3')
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th>dont bonus</th>
                                                                                    <td><input class="form-control" id="bonus"
                                                                                            name="bonus" type="text"
                                                                                ...
                                                                                <tr>
                                                                                    <td style="display:none" ; colspan="2">
                                                                                        <select name="lois" value="lois"
                                                                                            ...
                                                                                            required="false">
                                                                                            <option
                                                                                                value="<?php echo htmlentities($_SESSION['id']); ?>">
                                                                                                <?php echo htmlentities($_SESSION['id']); ?>
                                                                                            </option>
                                                                                        </select>
                                                                                    </td>
                                                                                    <td style="display:none" ; colspan="2">
                                                                                        <select name="activi" value="activi"
                                                                                            class="form-control"
                                                                                            required="false">
                                                                                            <option
                                                                                                value="<?php echo htmlentities($row['id-activite']); ?>">
                                        ...
                                        <div id="t1E">
                                            ...
                                            <div class="ccontainer-fluid ccontainer-fullw bg-dark-bricky "
                                                style="background-color:grey;opacity:1">
                                                ...
                                                <div id="main">
                                                    ...
                                                    <div class="players">
                                                        ...
                                                        <div class="player player-1 playing" id="player1">
                                                            <div class="avatar p1"
                                                                style="background: blue ;font-size: 1.7vw">
                                                                <form method="post">
                                                                    <?php if ($option[1] == 'Elimine')
                                                                        $nom = 'X';
                                                                    else
                                                                        $nom = $pseudo[1]; ?>
                                                                    <button type="submit" id='submitpl' value=<?php echo $idparticipation[1] ?>
                                                        ...
                                                        <div class="player player-2 playing" id="player2">
                                                            <div class="avatar p2"
                                                                style="background: red ;font-size: 1.7vw">
                                                                <form method="post">
                                                                    <?php if ($option[2] == 'Elimine')
                                                                        $nom = 'X';
                                                                    else
                                                                        $nom = $pseudo[2]; ?>
                                                                    <button type="submit" id='submitpl' value=<?php echo $idparticipation[2] ?>
                                                                        class="btbn btn-pokerred btn-block "
                                                                        name="submitpl"><?php echo $nom ?>
                                                                    </button>
                                                                </form>
                                                        ...
                                                        <div class="player player-3 playing" id="player3">
                                                            <div class="avatar p3"
                                                                style="background: black ;font-size:18px">
                                                                <form method="post">
                                                                    <?php if ($option[3] == 'Elimine')
                                                                        $nom = 'X';
                                                                    else
                                                                        $nom = $pseudo[3]; ?>
                                                                    <button type="submit" id='submitpl' value=<?php echo $idparticipation[3] ?>
                                                        ...
                                                        <div class="player player-4 playing" id="player4">
                                                            <div class="avatar p4"
                                                                style="background: orange; font-size:18px">
                                                                <form method="post">
                                                                    <?php if ($option[4] == 'Elimine')
                                                                        $nom = 'X';
                                                                    else
                                                                        $nom = $pseudo[4]; ?>
                                                                    <button type="submit" id='submitpl' value=<?php echo $idparticipation[4] ?>
                                                            ...
                                                            <div class="avatar p5" style="background: grey; font-size:18px">
                                                                <form method="post">
                                                                    <?php if ($option[5] == 'Elimine')
                                                                        ...
                                                                        $nom = $pseudo[5]; ?>
                                                                    <button type="submit" id='submitpl' value=<?php echo $idparticipation[5] ?>
                                                        ...
                                                        <div class="player player-6 playing" id="player6">
                                                            <div class="avatar p6"
                                                                style="background: brown; font-size:18px">
                                                                <form method="post">
                                                                    <?php if ($option[6] == 'Elimine')
                                                                        $nom = 'X';
                                                                    else
                                                                        $nom = $pseudo[6]; ?>
                                                                    <button type="submit" id='submitpl' value=<?php echo $idparticipation[6] ?>
                                                            ...
                                                            <div class="avatar p7" style="background: pink; font-size:18px">
                                                                <form method="post">
                                                                    <?php if ($option[7] == 'Elimine')
                                                                        ...
                                                                        $nom = $pseudo[7]; ?>
                                                                    <button type="submit" id='submitpl' value=<?php echo $idparticipation[7] ?>
                                                        ...
                                                        <div class="player player-8 playing" id="player8">
                                                            <div class="avatar p8"
                                                                style="background: purple; font-size:18px">
                                                                ...
                                                                <form method="post">
                                                                    <?php if ($option[8] == 'Elimine')
                                                                        ...
                                                                        $nom = $pseudo[8]; ?>
                                                                    <button type="submit" id='submitpl' value=<?php echo $idparticipation[8] ?>
                                                            ...
                                                            <div class="avatar p9" style="background: grey; font-size:18px">
                                                                <form method="post">
                                                                    <?php if ($option[9] == 'Elimine')
                                                                        ...
                                                                        $nom = $pseudo[9]; ?>
                                                                    <button type="submit" id='submitpl' value=<?php echo $idparticipation[9] ?>
                                                                        class="btnn btn-primary-orange2 btn-block"
                                                                        name="submitpl"><?php echo $nom ?>
                                                                    </button>
                                                                </form>
                                                        ...
                                                        <div class="player player-10 playing" id="player10">
                                                            <div class="avatar p10"
                                                                style="background: green; font-size:18px">
                                                                ...
                                                                <form method="post">
                                                                    <?php if ($option[10] == 'Elimine')
                                                                        ...
                                                                        $nom = $pseudo[10]; ?>
                                                                    <button type="submit" id='submitpl' value=<?php echo $idparticipation[10] ?>
                                                                        class="btnn btn-primary-noir btn-block"
                                                                        name="submitpl"><?php echo $nom ?>
                                                                    </button>
                                                            </div>
                                            ...
                                            $j = $j - 1;
                                            $h = (int) gmdate("H ", $ecar);
                                            $mi = (int) gmdate("i ", $ecar);
                                            $mi = $mi + 1;
                                            // $star="Début : ".$m." mois ".$j." Jour(s) ".$h." Heure(s) ".$mi." Minute(s)";
                                            $star = "Début dans " . $j . " Jour(s) " . $h . " Hre(s) et " . $mi . " Min(s)";
                                                        ...
                                                        <form method="post">
                                                            <tr>
                                                                <td style="text-align:center ; display:none">
                                                                    <button type="submit" name="xxx" id="submit"
                                                                        class="btn btn-oo btn-primary">
                                                                        Mise à jour
                                                                    </button>
                                                                </td>
                                                                <td style="text-align:center ;">
                                                                    <button type="submit" class="btn btn-primaryg btn-block"
                                                                        name="xxx">S'inscrire
                                                                    </button>
                                                                </td>
                                                                <td style="text-align:center ;">
                                                                ...
                                                                <td style="text-align:center ;">
                                                                    <button type="submit"
                                                                        class="btn btn-primary-rouge btn-block" name="xxx">Se
                                                                        désinscrire
                                                                    </button>
                                                                </td>
                                                            </tr>
                                            ...
                                            <?php } else {
                                                ...
                                                ?>
                                                <?php $_SESSION["act"] = $id;
                                                // include_once('horloge-pause.php'); 
                                                ?>
                                            <?php }
                                            ; ?>
                                        </div>
                                                                                                        ...
                                                                                                        while ($row = mysqli_fetch_array($ret)) { ?>
                                                                                                            ...
                                                                                                            while ($row2 = mysqli_fetch_array($sql2)) { ?>
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <a
                                                                                                                            href="voir-membre.php?id=<?php echo $row['id-membre']; ?>"><?php echo $row2['pseudo']; ?></a>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <?php echo $row['option']; ?>
                                                                                                                    </td>
