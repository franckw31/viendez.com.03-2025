...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['moins'])) {
        $id = $_GET['uid'];
        ?> <script type="text/javascript">window.location.replace("/panel/modif-horloge.php?act=<?php echo $id ?>&min=-5&sou=/panel/voir-blindes.php?uid=");</script> ; <?php
    ...
    if (isset($_POST['moins1'])) {
        $id = $_GET['uid'];
        ?> <script type="text/javascript">window.location.replace("/panel/modif-horloge.php?act=<?php echo $id ?>&min=-1&sou=/panel/voir-blindes.php?uid=");</script> ; <?php
    ...
    if (isset($_POST['pauseresume'])) {
        ...
        ?> <script type="text/javascript">window.location.replace("/panel/en-pause.php?act=<?php echo $id ?>&sou=/panel/voir-blindes.php?uid=");</script> ; <?php
        }
        if ($_SESSION["en_pause".$id] =="1") {
            ?> <script type="text/javascript">window.location.replace("/panel/de-pause.php?act=<?php echo $id ?>&sou=/panel/voir-blindes.php?uid=");</script> ; <?php
            }
                                    ...
                                    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
                                        <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
                                            <head>
                                                ...
                                                <script type="text/javascript">$(document).ready(function () {
                                                        $('#example2').DataTable({ order: [[0, 'asc']], pageLength: 8, language: { url: '//cdn.datatables.net/plug-ins/1.13.6/i18n/fr-FR.json' } });
                                                    });</script>
                                                <script type="text/javascript">$(document).ready(function () {
                                                        $('#example3').DataTable({ pageLength: 8, language: { url: '//cdn.datatables.net/plug-ins/1.13.6/i18n/fr-FR.json' } });
                                                    });</script>
                                                                    ...
                                                                    <div id="contenu">
                                                                        <div id="auCentre">
                                                                            ...
                                                                            {?>
                                                                                ...
                                                                                <a href="#" id="Structure" class="btnnav" onmouseover="afficher1('Structure')">Modèles</a>
                                                                            ...
                                                                            {?>
                                                                                ...
                                                                                <a href="#" id="Structure" class="btnnav" onmouseover="afficher2('Structure')">Modèles</a>
                                                                                                                ...
                                                                                                                <div class="ppanel panel-wwhite">
                                                                                                                    <div class="ppanel-body">
                                                                                                                        ...
                                                                                                                        <div style="color:red ; font-size: 200px ; text-align: center;" id="response"></div>
                                                                                                                                        ...
                                                                                                                                        <tr>    
                                                                                                                                            <td colspan="3" style="text-align:center ;">
                                                                                                                                                <button type="submit"
                                                                                                                                                    ...
                                                                                                                                                    name="moins"><<< -5 Minutes
                                                                                                                                                </button>
                                                                                                                                            </td>
                                                                                                                                            <td colspan="3" style="text-align:center ;">
                                                                                                                                                <button type="submit"
                                                                                                                                                    class="btn btn-primary btn-block"
                                                                                                                                                    name="pauseresume">Pause / Resume
                                                                                                                                                </button>
                                                                                                                                            </td>
                                                                                                                                            <td colspan="3" style="text-align:center ;">
                                                                                                                                                <button 
                                                                                                                                        ...
                                                                                                                                        <tr>    
                                                                                                                                            <td colspan="3" style="text-align:center ;">
                                                                                                                                                <button type="submit"
                                                                                                                                                    id="moins1" 
                                                                                                                                                    class="btn btn-primaryg btn-block"
                                                                                                                                                    name="moins1"><<< -1 Minute
                                                                                                                                                </button>
                                                                                                                                            </td>
                                                                                                                                            <td colspan="3" style="text-align:center ;">
                                                                                                                                                <button type="submit"
                                                                                                                                                    class="btn btn-primary btn-block"
                                                                                                                                                    name="pauseresume">Reset blinde
                                                                                                                                                </button>
                                                                                                                                            </td>
                                                                                                                                            <td colspan="3" style="text-align:center ;">
                                                                                                                                                <button 
                                                                                                                            ...
                                                                                                                            <div style="color:grey ; font-size: 30px ; text-align: center" id="response-estim"></div>    
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                            ...
                                                                            <!--    <h1 class="mt-4">Gestion des Competences</h1> -->
                                                                                 ...
                                                                                 <!--   <div class="card-header">
                                                                                    ...
                                                                                    Registered User Details
                                                                                                                                        ...
                                                                                                                                        <div class="card-body">
                                                                                       <!-- <table id="datatablesSimple">cell-border compact stripe hover -->
                                                                                                                                            <table
                                                                                                                                                id="example2"
                                                                                                                                                ...
                                                                                                                                                <tbody>
                                                                                                                                                    <?php 
                                                                                                                                                    $ret = mysqli_query($con, "SELECT * FROM `structure_modele` WHERE `id_modele_structure` = '1'");
                                                                                                                                                    $cnt = 1;
                                                                                                                                                    ...
                                                                                                                                                    while ($row = mysqli_fetch_array($ret)) { ?>
                                                                                                                                                        ...
                                                                                                                                                        $id2 = $row['id_orga'];    echo $id2;                                                                                                                                                 $sql2 = mysqli_query($con, "SELECT * FROM `activite` WHERE `id-activite` = '$id2'");
                                                                                                                                                        while ($row2 = mysqli_fetch_array($sql2)) { 
                                                                                                                                                            $sql0 = mysqli_query($con, "SELECT * FROM `membres` WHERE `id-membre` =  '$id2'");
                                                                    ...
                                                                    <div class="panel-body">
                                                                        <div id="layoutSidenav_content">
                                                                            ...
                                                                            <!--    <h1 class="mt-4">Gestion des Competences</h1> -->
                                                                                    <ol class="breadcrumb mb-4">
                                                                                        <li class="breadcrumb-item">
                                                                                            <a href="liste-membres.php">Blindes</a>
                                                                                        </li>
                                                                                        <li class="breadcrumb-item active">
                                                                                            Edition
                                                                                        </li>
