    ...
    if (mysqli_num_rows(mysqli_query($conx, "SELECT * FROM register WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {
            ...
            try {
                ...
                $mail->Body    = '<p> Inscription Prise en compte <b><a href="http://poker31.org/reg/change-Password.php?Reset=' . $CodeReset . '">"http://poker31.org/reg/change-Password.php?Reset=' . $CodeReset . '"</a></b></p>';
