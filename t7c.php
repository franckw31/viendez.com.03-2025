...
<body class="bg-light">
                        ...
                        <tbody>
                            ...
                            <tr class="clickable-row" data-id="<?= $row['id'] ?>">
                                ...
                                <td class="input-container">
                                    <input type="text" class="form-control" value="<?= ucwords(strtolower($row['first_name'])) ?>" name="first_name[<?= $row['id'] ?>]" readonly>
                                    <i class="bi bi-pencil-square edit-icon" data-id="<?= $row['id'] ?>" data-field="first_name"></i>
                                </td>
                                <td class="input-container">
                                    <input type="text" class="form-control" value="<?= strtoupper($row['last_name']) ?>" name="last_name[<?= $row['id'] ?>]" readonly>
                                    <i class="bi bi-pencil-square edit-icon" data-id="<?= $row['id'] ?>" data-field="last_name"></i>
                                </td>
                                <td class="input-container">
                                    <input type="text" class="form-control" value="<?= $row['position'] ?>" name="position[<?= $row['id'] ?>]" readonly>
                                    <i class="bi bi-pencil-square edit-icon" data-id="<?= $row['id'] ?>" data-field="position"></i>
                                </td>
                                <td class="input-container">
                                    <input type="text" class="form-control" value="<?= $row['office'] ?>" name="office[<?= $row['id'] ?>]" readonly>
                                    <i class="bi bi-pencil-square edit-icon" data-id="<?= $row['id'] ?>" data-field="office"></i>
                                </td>
                                <td class="input-container">
                                    <input type="date" class="form-control" value="<?= $row['start_date'] ?>" name="start_date[<?= $row['id'] ?>]" readonly>
                                    <i class="bi bi-pencil-square edit-icon" data-id="<?= $row['id'] ?>" data-field="start_date"></i>
                                </td>
                                <td class="input-container">
                                    <input type="number" step="0.01" class="form-control salary-cell" value="<?= $row['salary'] ?>" name="salary[<?= $row['id'] ?>]" readonly>
    ...
    $(document).ready(function() {
        ...
        $('#employeeTable').on('click', '.save-icon', function(event) {
