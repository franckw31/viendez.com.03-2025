            ...
            <div id="cp">
                <div class="fragment-content">
                    <div>
                        ...
                        src="images/webmin.png"/>Webmin 192.168.1.134</a>
                    </div>
                    <div>
                        <a href="https://<?php print
                        $_SERVER['HTTP_HOST']; ?>:12322"><img
                        src="images/adminer.png"/>Adminer 192.168.1.134</a>
                    </div>
<div>
                        <a href="https://<?php print
                        $_SERVER['HTTP_HOST']; ?>/phpmyadmin"><img
                        src="images/adminer.png"/>Phpmyadmin adminer Kookies7*</a>
                    </div>
